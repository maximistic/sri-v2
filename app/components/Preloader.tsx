...
export default function Intro() {
  ...
  return (
    <motion.div
      ...
      initial="initial"
      exit="exit"
      className="fixed top-0 left-0 w-screen h-screen flex items-center justify-center bg-[#141516] z-[99]"
    >
      {dimension.width > 0 && (
        <>
          <motion.p
            ...
            initial="initial"
            animate="enter"
            className="flex items-center text-white text-[30px] z-10 absolute"
          >
