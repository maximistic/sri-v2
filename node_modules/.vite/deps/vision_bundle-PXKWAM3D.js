...
var U = class {
  constructor(t2, e2) {
    if (R(e2), this.T = t2, null != t2 && 0 === t2.length) throw Error("ByteString should be constructed with non-empty values");
  }
  qa() {
    const t2 = B(this);
...
function z(t2) {
  if ("string" == typeof t2) return { buffer: L(t2), H: false };
  if (Array.isArray(t2)) return { buffer: new Uint8Array(t2), H: false };
  if (t2.constructor === Uint8Array) return { buffer: t2, H: false };
  if (t2.constructor === ArrayBuffer) return { buffer: new Uint8Array(t2), H: false };
  if (t2.constructor === U) return { buffer: B(t2) || P(), H: true };
  if (t2 instanceof Uint8Array) return { buffer: new Uint8Array(t2.buffer, t2.byteOffset, t2.byteLength), H: false };
...
function et(t2, e2) {
  ...
  else W() ? n2 = "" + (BigInt(e2) << BigInt(32) | BigInt(t2)) : (t2 = (16777215 & t2) + 6777216 * (n2 = 16777215 & (t2 >>> 24 | e2 << 8)) + 6710656 * (e2 = e2 >> 16 & 65535), n2 += 8147497 * e2, e2 *= 2, 1e7 <= t2 && (n2 += Math.floor(t2 / 1e7), t2 %= 1e7), 1e7 <= n2 && (e2 += Math.floor(n2 / 1e7), n2 %= 1e7), n2 = e2 + nt(n2) + nt(t2));
  return n2;
}
function nt(t2) {
...
function rt() {
  var t2 = $, e2 = q;
  if (2147483648 & e2) if (W()) t2 = "" + (BigInt(0 | e2) << BigInt(32) | BigInt(t2 >>> 0));
  else {
...
function it(t2) {
  if (16 > t2.length) J(Number(t2));
  else if (W()) t2 = BigInt(t2), $ = Number(t2 & BigInt(4294967295)) >>> 0, q = Number(t2 >> BigInt(32) & BigInt(4294967295));
  else {
    const e2 = +("-" === t2[0]);
    q = $ = 0;
    const n2 = t2.length;
...
function at(t2, e2) {
  if (t2.g = e2, e2 > t2.l) throw j(t2.l, e2);
}
function ct(t2, e2) {
  ...
  if (at(t2, a2), 128 > n2) return e2(r2 >>> 0, i2 >>> 0);
  throw G();
}
function ht(t2) {
  let e2 = 0, n2 = t2.g;
  ...
  for (; n2 < r2; ) {
    const r3 = i2[n2++];
    if (e2 |= r3, 0 == (128 & r3)) return at(t2, n2), !!(127 & e2);
  }
  throw G();
}
function ut(t2) {
...
var dt = class {
  ...
  m() {
    ...
    if (128 & n2 && (n2 = t2[e2++], r2 |= (127 & n2) << 7, 128 & n2 && (n2 = t2[e2++], r2 |= (127 & n2) << 14, 128 & n2 && (n2 = t2[e2++], r2 |= (127 & n2) << 21, 128 & n2 && (n2 = t2[e2++], r2 |= n2 << 28, 128 & n2 && 128 & t2[e2++] && 128 & t2[e2++] && 128 & t2[e2++] && 128 & t2[e2++] && 128 & t2[e2++]))))) throw G();
...
function gt(t2) {
  ...
  t2.l = t2.g.g;
  var n2 = t2.g.j();
  if (e2 = n2 >>> 3, !(0 <= (n2 &= 7) && 5 >= n2)) throw N(n2, t2.l);
...
function mt(t2) {
  switch (t2.h) {
    ...
    case 3:
      for (e2 = t2.m; ; ) {
        if (!gt(t2)) throw Error("Unmatched start-group tag: stream EOF");
        if (4 == t2.h) {
...
function wt(t2, e2, n2) {
  var r2 = t2.g.j();
  for (r2 = t2.g.g + r2; t2.g.g < r2; ) n2.push(e2.call(t2.g));
}
var bt = [];
function Et(t2) {
...
function ie(t2, e2, n2) {
  if (null != t2) {
    if ("string" == typeof t2) t2 = t2 ? new U(t2, I) : D();
    else if (t2.constructor !== U) if (M(t2)) t2 = n2 ? V(t2) : t2.length ? new U(new Uint8Array(t2), I) : D();
    else {
      if (!e2) throw Error();
      t2 = void 0;
    }
...
function Fe(t2, e2, n2, r2) {
  if (null != t2 && "object" == typeof t2 && t2.P === Qt) return t2;
  if (!Array.isArray(t2)) return n2 ? 2 & r2 ? (t2 = e2[Le]) ? e2 = t2 : ($t((t2 = new e2()).s), e2 = e2[Le] = t2) : e2 = new e2() : e2 = void 0, e2;
  let i2 = n2 = Xt(t2);
...
function Be(t2, e2, n2) {
  if (null == t2 && (t2 = Pe), Pe = void 0, null == t2) {
    ...
    if (!Array.isArray(t2)) throw Error();
    if (64 & (r2 = Xt(t2))) return fe && delete t2[fe], t2;
    if (r2 |= 64, n2 && (r2 |= 512, n2 !== t2[0])) throw Error();
    t: {
      if (n2 = r2, r2 = t2.length) {
        const i2 = r2 - 1;
        if (ne(t2[i2])) {
          if (1024 <= (e2 = i2 - (+!!(512 & (n2 |= 256)) - 1))) throw Error();
          r2 = -16760833 & n2 | (1023 & e2) << 14;
          break t;
        }
      }
      if (e2) {
        if (1024 < (e2 = Math.max(e2, r2 - (+!!(512 & n2) - 1)))) throw Error();
        r2 = -16760833 & n2 | (1023 & e2) << 14;
      } else r2 = n2;
    }
  }
...
function je(t2) {
  if (2 & t2.I) throw Error("Cannot mutate an immutable Map");
}
...
function He(t2, e2, n2, r2, i2, s2) {
  if (null != t2) {
    if (Array.isArray(t2)) t2 = i2 && 0 == t2.length && 1 & Xt(t2) ? void 0 : s2 && 2 & Xt(t2) ? t2 : Ye(t2, e2, n2, void 0 !== r2, i2, s2);
    else if (ne(t2)) {
      const o2 = {};
      for (let a2 in t2) o2[a2] = He(t2[a2], e2, n2, r2, i2, s2);
      t2 = o2;
    } else t2 = e2(t2, r2);
    return t2;
  }
...
function Ye(t2, e2, n2, r2, i2, s2) {
  ...
  r2 = r2 ? !!(32 & o2) : void 0;
  const a2 = Nt(t2);
  for (let t3 = 0; t3 < a2.length; t3++) a2[t3] = He(a2[t3], e2, n2, r2, i2, s2);
...
function $e(t2) {
  return t2.P === Qt ? t2.toJSON() : t2 instanceof Ve ? t2.ka(Ke) : function(t3) {
    switch (typeof t3) {
      ...
      case "object":
        if (t3) {
          if (Array.isArray(t3)) return re || !se(t3, void 0, 9999) ? t3 : void 0;
          if (M(t3)) return k(t3);
          if (t3 instanceof U) {
            const e2 = t3.T;
            return null == e2 ? "" : "string" == typeof e2 ? e2 : t3.T = k(e2);
          }
          if (t3 instanceof Ve) return t3 = t3.ka(), X || 0 !== t3.length ? t3 : void 0;
        }
    }
    return t3;
  }(t2);
...
function en(t2, e2, n2, r2) {
  if (-1 === n2) return null;
  if (n2 >= Zt(e2)) {
    if (256 & e2) return t2[t2.length - 1][n2];
  } else {
    var i2 = t2.length;
    if (r2 && 256 & e2 && null != (r2 = t2[i2 - 1][n2])) return r2;
    if ((e2 = n2 + (+!!(512 & e2) - 1)) < i2) return t2[e2];
  }
}
...
function rn(t2, e2, n2, r2, i2) {
  var s2 = Zt(e2);
  if (n2 >= s2 || i2) {
    if (i2 = e2, 256 & e2) s2 = t2[t2.length - 1];
    else {
      if (null == r2) return i2;
...
function yn(t2, e2, n2, r2) {
  ...
  let o2;
  if (null != s2 && s2.P === Qt) return (e2 = Qe(s2)) !== s2 && rn(t2, i2, n2, e2, r2), e2.s;
  if (Array.isArray(s2)) {
    const t3 = Xt(s2);
    o2 = 2 & t3 ? Ze(s2, t3, false) : s2, o2 = De(o2, e2);
  } else o2 = De(void 0, e2);
...
function _n(t2, e2, n2, r2 = false) {
  if (null == (e2 = vn(t2, e2, n2, r2))) return e2;
  t2 = t2.s;
  let i2 = Ht(t2);
  if (!(2 & i2)) {
    const s2 = Qe(e2);
...
function wn(t2, e2, n2, r2, i2, s2, o2) {
  ...
  if (n2 = u2, c2 = !!(8 & u2) || a2 && !h2.length, o2 && !c2) {
    for (p2 && (h2 = Nt(h2), p2 = false, n2 = 0, u2 = Tn(u2, e2, s2), e2 = rn(t2, e2, r2, h2)), o2 = h2, c2 = u2, l2 = 0; l2 < o2.length; l2++) (g2 = o2[l2]) !== (u2 = Qe(g2)) && (o2[l2] = u2);
...
function Mn(t2, e2, n2) {
  if (null != n2) {
    if ("boolean" != typeof n2) throw t2 = typeof n2, Error(`Expected boolean but got ${"object" != t2 ? t2 : n2 ? Array.isArray(n2) ? "array" : t2 : "null"}: ${n2}`);
    n2 = !!n2;
  }
  nn(t2, e2, n2);
}
function On(e2, n2, r2) {
  if (null != r2) {
    if ("number" != typeof r2) throw ge("int32");
...
function Rn(t2, e2, n2) {
  ...
  if (r2 && re) {
    if (!n2) {
      ...
      if ((e2 = Nt(e2)).length && ne(a2 = e2[e2.length - 1])) {
        for (o2 = 0; o2 < r2.length; o2++) if (r2[o2] >= s2) {
  ...
  if (!(c2 = e2.length)) return e2;
  let f2, d2;
  if (ne(l2 = e2[c2 - 1])) {
    t: {
      var p2 = l2;
      for (var g2 in s2 = {}, n2 = false, p2) t2 = p2[g2], Array.isArray(t2) && (a2 = t2, (!H && se(t2, r2, +g2) || !X && ee(t2) && 0 === t2.size) && (t2 = null), t2 != a2 && (n2 = true)), null != t2 ? s2[g2] = t2 : n2 = true;
      if (n2) {
        for (let t3 in s2) {
          p2 = s2;
          break t;
  ...
  for (i2 = +!!(512 & i2) - 1; 0 < c2 && (null == (l2 = e2[g2 = c2 - 1]) || !H && se(l2, r2, g2 - i2) || !X && ee(l2) && 0 === l2.size); c2--) d2 = true;
...
function Kn(t2, e2, n2, r2, i2 = Yn) {
  ...
  for (; Array.isArray(o2) && "number" == typeof o2[0] && 0 < o2[0]; ) {
    for (var c2 = 0; c2 < o2.length; c2++) a2[o2[c2]] = o2;
    o2 = t2[++s2];
  }
  for (c2 = 1; void 0 !== o2; ) {
    let l2;
...
function or(t2, e2, n2) {
  ...
  if (256 & r2) {
    r2 = t2[s2 - 1];
    for (let t3 in r2) i2 = +t3, Number.isNaN(i2) || null != (s2 = r2[t3]) && (a2 = sr(n2, i2)) && a2(e2, s2, i2);
  }
  if (t2 = le ? t2[le] : void 0) for (Pt(e2, e2.g.end()), n2 = 0; n2 < t2.length; n2++) Pt(e2, B(t2[n2]) || P());
}
function ar(t2, e2) {
...
var lr = hr(function(t2, e2, n2, r2, i2) {
  ...
  if (e2 instanceof Ve) e2.forEach((e3, s2) => {
...
var Er = cr(vr, function(t2, e2, n2) {
  if (null != (e2 = Bn(me, e2))) for (let s2 = 0; s2 < e2.length; s2++) {
    var r2 = t2, i2 = e2[s2];
...
var Ar = cr(vr, function(t2, e2, n2) {
  if (null != (e2 = Bn(me, e2)) && e2.length) {
    ...
    for (let r2 = 0; r2 < e2.length; r2++) n2 = t2.g, Z(e2[r2]), Ot(n2, $);
  }
});
...
var Pr = cr(function(t2, e2, n2) {
  ...
  if (null != (e2 = Bn(xe, e2))) for (let i2 = 0; i2 < e2.length; i2++) {
    var r2 = e2[i2];
...
_r = new Ut(function(t2, e2, n2, r2, i2) {
  ...
  if (Array.isArray(e2)) for (let s2 = 0; s2 < e2.length; s2++) mr(t2, e2[s2], n2, r2, i2);
}, true, true);
...
var Nr = cr(function(t2, e2, n2) {
  ...
  if (null != (e2 = Bn(be, e2))) for (let s2 = 0; s2 < e2.length; s2++) {
    var r2 = t2, i2 = e2[s2];
  ...
  g() {
    ...
    return t2 = function(t3, e3, n3) {
      ...
      if (null == n3) {
        ...
        if (0 == (2 & n3.I) || i2) return n3;
        n3 = n3.R();
      } else Array.isArray(n3) ? s2 = !!(2 & Xt(n3)) : n3 = [];
      if (i2) {
        if (!n3.length) return un();
        s2 || (s2 = true, $t(n3));
      } else s2 && (s2 = false, n3 = ln(n3));
...
function yo(t2) {
  ...
  if ((e2 = (_a2 = _n(t2, Ui, 4)) == null ? void 0 : _a2.h()) && (s2.boundingBox = { originX: Sn(e2, 1) ?? 0, originY: Sn(e2, 2) ?? 0, width: Sn(e2, 3) ?? 0, height: Sn(e2, 4) ?? 0, angle: 0 }), (_b = _n(t2, Ui, 4)) == null ? void 0 : _b.g().length) for (const e3 of _n(t2, Ui, 4).g()) s2.keypoints.push({ x: on(e3, 1) ?? 0, y: on(e3, 2) ?? 0, score: on(e3, 4) ?? 0, label: xn(e3, 3) ?? "" });
  return s2;
}
function vo(t2) {
  const e2 = [];
  for (const n2 of bn(t2, Hi, 1)) e2.push({ x: Ln(n2, 1) ?? 0, y: Ln(n2, 2) ?? 0, z: Ln(n2, 3) ?? 0 });
  return e2;
}
function _o(t2) {
  const e2 = [];
  for (const n2 of bn(t2, Vi, 1)) e2.push({ x: Ln(n2, 1) ?? 0, y: Ln(n2, 2) ?? 0, z: Ln(n2, 3) ?? 0 });
  return e2;
}
function wo(t2) {
...
async function Co(t2, e2, n2, r2) {
  return t2 = await (async (t3, e3, n3, r3, i2) => {
    if (e3 && await Fo(e3), !self.ModuleFactory) throw Error("ModuleFactory not set.");
    if (n3 && (await Fo(n3), !self.ModuleFactory)) throw Error("ModuleFactory not set.");
...
function Do(t2) {
  try {
    ...
    if (1 === e2) throw Error(t2.L[0].message);
    if (1 < e2) throw Error("Encountered multiple errors: " + t2.L.map((t3) => t3.message).join(", "));
  } finally {
    t2.L = [];
  }
}
...
var jo = class {
  ...
  l(t2, e2 = true) {
    ...
    if (e2) {
      ...
      if (!(((_c2 = _n(this.baseOptions, ms, 1)) == null ? void 0 : _c2.g()) || ((_d = _n(this.baseOptions, ms, 1)) == null ? void 0 : _d.h()) || ((_e2 = t2.baseOptions) == null ? void 0 : _e2.modelAssetBuffer) || ((_f = t2.baseOptions) == null ? void 0 : _f.modelAssetPath))) throw Error("Either baseOptions.modelAssetPath or baseOptions.modelAssetBuffer must be set");
      if (function(t3, e4) {
...
function Vo(t2, e2) {
  if (null === t2) throw Error(`Unable to obtain required WebGL resource: ${e2}`);
  return t2;
}
...
function Wo(t2, e2, n2) {
  const r2 = t2.h;
  if (n2 = Vo(r2.createShader(n2), "Failed to create WebGL shader"), r2.shaderSource(n2, e2), r2.compileShader(n2), !r2.getShaderParameter(n2, r2.COMPILE_STATUS)) throw Error(`Could not compile WebGL shader: ${r2.getShaderInfoLog(n2)}`);
...
function Ho(t2, e2) {
  if (t2.h) {
    if (e2 !== t2.h) throw Error("Cannot change GL context once initialized");
  } else t2.h = e2;
}
function Yo(t2, e2, n2, r2) {
  if (Ho(t2, e2), !t2.g) {
    const e3 = t2.h;
    if (t2.g = Vo(e3.createProgram(), "Failed to create WebGL program"), t2.C = Wo(t2, "\n  attribute vec2 aVertex;\n  attribute vec2 aTex;\n  varying vec2 vTex;\n  void main(void) {\n    gl_Position = vec4(aVertex, 0.0, 1.0);\n    vTex = aTex;\n  }", e3.VERTEX_SHADER), t2.v = Wo(t2, "\n  precision mediump float;\n  varying vec2 vTex;\n  uniform sampler2D inputTexture;\n  void main() {\n    gl_FragColor = texture2D(inputTexture, vTex);\n  }\n ", e3.FRAGMENT_SHADER), e3.linkProgram(t2.g), !e3.getProgramParameter(t2.g, e3.LINK_STATUS)) throw Error(`Error during program linking: ${e3.getProgramInfoLog(t2.g)}`);
...
function Zo(t2) {
  var e2 = Jo(t2, 1);
  if (!e2) {
    if (e2 = Jo(t2, 0)) e2 = new Float32Array(e2).map((t3) => t3 / 255);
    else {
...
function ea(t2) {
  if (t2 = ta(t2), !oa) if (t2.getExtension("EXT_color_buffer_float") && t2.getExtension("OES_texture_float_linear") && t2.getExtension("EXT_float_blend")) oa = t2.R32F;
  else {
...
function da(t2) {
  if (!t2.g) throw Error("CPU rendering requested but CanvasRenderingContext2D not provided.");
  return t2.g;
}
var pa = class {
  constructor(t2) {
  ...
  wa(t2, e2) {
    if (t2) {
      ...
      for (const s2 of t2) n2.fillStyle = la(e2.fillColor, { index: i2, from: s2 }), n2.strokeStyle = la(e2.color, { index: i2, from: s2 }), n2.lineWidth = la(e2.lineWidth, { index: i2, from: s2 }), (t2 = new Path2D()).arc(s2.x * r2.width, s2.y * r2.height, la(e2.radius, { index: i2, from: s2 }), 0, 2 * Math.PI), n2.fill(t2), n2.stroke(t2), ++i2;
      n2.restore();
    }
  }
  va(t2, e2, n2) {
...
var xa = /* @__PURE__ */ function(t2) {
  ...
  addStringVectorToStream(t2, e2, n2) {
    Lo(this, e2, (e3) => {
      ...
      for (const e4 of t2) Lo(this, e4, (t3) => {
...
function Ca(t2, e2, n2) {
  ...
  if ((r2 instanceof Uint8Array || r2 instanceof Float32Array) && r2.length !== s2) throw Error("Unsupported channel count: " + r2.length / s2);
...
var Ra = class extends jo {
  ...
  l(t2, e2 = true) {
    if ("runningMode" in t2 && Mn(this.baseOptions, 2, !!t2.runningMode && "IMAGE" !== t2.runningMode), void 0 !== t2.canvas && this.g.i.canvas !== t2.canvas) throw Error("You must create a new task to reset the canvas.");
...
var Da = class extends Ra {
  ...
  m() {
    ...
    ui(n2, "mediapipe.tasks.vision.face_detector.FaceDetectorGraph"), li(n2, "IMAGE:image_in"), li(n2, "NORM_RECT:norm_rect_in"), fi(n2, "DETECTIONS:detections"), n2.o(e2), _i(t2, n2), this.g.attachProtoVectorListener("detections", (t3, e3) => {
      for (const e4 of t3) t3 = ji(e4), this.j.detections.push(yo(t3));
      Bo(this, e3);
...
var Ka = class extends Ra {
  ...
  m() {
    ...
    ui(n2, "mediapipe.tasks.vision.face_landmarker.FaceLandmarkerGraph"), li(n2, "IMAGE:image_in"), li(n2, "NORM_RECT:norm_rect"), fi(n2, "NORM_LANDMARKS:face_landmarks"), n2.o(e2), _i(t2, n2), this.g.attachProtoVectorListener("face_landmarks", (t3, e3) => {
      for (const e4 of t3) t3 = $i(e4), this.j.faceLandmarks.push(vo(t3));
      Bo(this, e3);
      ...
      if (this.outputFaceBlendshapes) for (const e4 of t3) t3 = Mi(e4), this.j.faceBlendshapes.push(mo(t3.g() ?? []));
      Bo(this, e3);
      ...
      if (this.outputFacialTransformationMatrixes) for (const e4 of t3) (t3 = _n(ks(e4), qi, 2)) && this.j.facialTransformationMatrixes.push({ rows: Fn(Sn(t3, 1)) ?? 0, columns: Fn(Sn(t3, 2)) ?? 0, data: cn(t3, 3, me) ?? [] });
      Bo(this, e3);
...
var $a = class extends Ra {
  ...
  Pa(t2, e2, n2) {
    ...
    if (this.h = "function" == typeof e2 ? e2 : n2, Pa(this, t2, r2 ?? {}), !this.h) return this.u;
  }
  m() {
    var t2 = new Ei();
...
function Qa(t2, e2 = true) {
  ...
  for (const i2 of t2) {
    var r2 = Mi(i2);
    t2 = [];
    for (const n3 of r2.g()) r2 = e2 && null != Sn(n3, 1) ? Fn(Sn(n3, 1)) : -1, t2.push({ score: Ln(n3, 2) ?? 0, index: r2, categoryName: xn(n3, 3) ?? "" ?? "", displayName: xn(n3, 4) ?? "" ?? "" });
    n2.push(t2);
  }
  return n2;
}
var tc = class extends Ra {
  ...
  o(t2) {
    ...
    } else void 0 === t2.cannedGesturesClassifierOptions && ((_b = _n(this.j, Cs, 3)) == null ? void 0 : _b.g());
  ...
  m() {
    ...
    ui(n2, "mediapipe.tasks.vision.gesture_recognizer.GestureRecognizerGraph"), li(n2, "IMAGE:image_in"), li(n2, "NORM_RECT:norm_rect"), fi(n2, "HAND_GESTURES:hand_gestures"), fi(n2, "LANDMARKS:hand_landmarks"), fi(n2, "WORLD_LANDMARKS:world_hand_landmarks"), fi(n2, "HANDEDNESS:handedness"), n2.o(e2), _i(t2, n2), this.g.attachProtoVectorListener("hand_landmarks", (t3, e3) => {
      for (const e4 of t3) {
        t3 = $i(e4);
        const n3 = [];
        for (const e5 of bn(t3, Hi, 1)) n3.push({ x: Ln(e5, 1) ?? 0, y: Ln(e5, 2) ?? 0, z: Ln(e5, 3) ?? 0 });
      ...
      for (const e4 of t3) {
        t3 = Xi(e4);
        const n3 = [];
        for (const e5 of bn(t3, Vi, 1)) n3.push({ x: Ln(e5, 1) ?? 0, y: Ln(e5, 2) ?? 0, z: Ln(e5, 3) ?? 0 });
...
var nc = class extends Ra {
  ...
  m() {
    ...
    ui(n2, "mediapipe.tasks.vision.hand_landmarker.HandLandmarkerGraph"), li(n2, "IMAGE:image_in"), li(n2, "NORM_RECT:norm_rect"), fi(n2, "LANDMARKS:hand_landmarks"), fi(n2, "WORLD_LANDMARKS:world_hand_landmarks"), fi(n2, "HANDEDNESS:handedness"), n2.o(e2), _i(t2, n2), this.g.attachProtoVectorListener("hand_landmarks", (t3, e3) => {
      for (const e4 of t3) t3 = $i(e4), this.landmarks.push(vo(t3));
      Bo(this, e3);
    }), this.g.attachEmptyPacketListener("hand_landmarks", (t3) => {
      Bo(this, t3);
    }), this.g.attachProtoVectorListener("world_hand_landmarks", (t3, e3) => {
      for (const e4 of t3) t3 = Xi(e4), this.worldLandmarks.push(_o(t3));
      Bo(this, e3);
    }), this.g.attachEmptyPacketListener("world_hand_landmarks", (t3) => {
      Bo(this, t3);
    }), this.g.attachProtoVectorListener("handedness", (t3, e3) => {
      ...
      for (const e4 of t3) {
        t3 = Mi(e4);
        const n4 = [];
        for (const e5 of t3.g()) n4.push({ score: Ln(e5, 2) ?? 0, index: Fn(Sn(e5, 1)) ?? -1, categoryName: xn(e5, 3) ?? "" ?? "", displayName: xn(e5, 4) ?? "" ?? "" });
        i2.push(n4);
      }
    ...
    ui(n2, "mediapipe.tasks.vision.image_embedder.ImageEmbedderGraph"), li(n2, "IMAGE:image_in"), li(n2, "NORM_RECT:norm_rect"), fi(n2, "EMBEDDINGS:embeddings_out"), n2.o(e2), _i(t2, n2), this.g.attachProtoListener("embeddings_out", (t3, e3) => {
      t3 = hs(t3), this.embeddings = function(t4) {
        return { embeddings: bn(t4, ss, 1).map((t5) => {
          ...
          if (void 0 !== vn(t5, rs, gn(t5, 1))) t5 = cn(t5 = _n(t5, rs, gn(t5, 1)), 1, me), e4.floatEmbedding = t5;
          else {
...
ic.cosineSimilarity = function(t2, e2) {
  if (t2.floatEmbedding && e2.floatEmbedding) t2 = bo(t2.floatEmbedding, e2.floatEmbedding);
  else {
...
var Lc = class extends Ra {
  ...
  ba(t2, e2, n2, r2) {
    ...
    const s2 = new Tc();
    var o2 = new uc();
    if (On(o2, 1, 255), En(s2, 0, 12, o2), e2.keypoint && e2.scribble) throw Error("Cannot provide both keypoint and scribble.");
    if (e2.keypoint) {
      var a2 = new bc();
      ...
      for (a2 of (o2 = new Ac(), e2.scribble)) Mn(e2 = new bc(), 3, true), Pn(e2, 1, a2.x), Pn(e2, 2, a2.y), kn(o2, bc, e2);
      An(s2, 15, kc, o2);
    }
...
//# sourceMappingURL=vision_bundle-PXKWAM3D.js.map
