                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between py-4 md:py-6 px-4 cursor-pointer">
                  <div className="flex-1">
                    <div className="flex flex-col md:flex-row md:items-baseline gap-2 md:gap-4">
                      <h2 className="text-xl md:text-2xl font-light group-hover:text-blue-400 transition-colors duration-300">
                        {cert.title}
                      </h2>
                  ...
                  <div className="flex items-center justify-between md:justify-end gap-4 md:gap-6 mt-3 md:mt-0">
                    ...
                    <div className="flex items-center gap-2">
                      <div className="w-2 h-2 bg-gray-600 rounded-full group-hover:bg-blue-400 transition-colors duration-300"></div>
                      {isMobile && (
                  ...
                  <div className="px-4 pb-4 border-t border-gray-800 mt-4">
                    <div className="pt-4">
                      <div className="bg-gradient-to-br from-blue-500/20 to-purple-500/20 rounded-lg p-4 border border-white/10">
                        <div className="flex items-center justify-center mb-4 h-32 bg-gradient-to-br from-blue-500 to-purple-600 rounded-lg">
                          <div className="text-center text-white">
